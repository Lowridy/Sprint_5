...
CONFIRM_PASSWORD_FIELD = (By.NAME, "submitPassword")  # Обновлено на основе предоставленного HTML

# Элементы после успешной регистрации
...
# Поля формы размещения объявления
